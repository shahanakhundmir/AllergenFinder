            ...
            <Navbar collapseOnSelect className="menu" expand="md" fixed="top" >
                ...
                <Navbar.Collapse className="navbar-collapse">
                    <Nav className="mr-auto">
                        <Nav.Link onClick={() => selectSubMenu('Starters')} className="menu-item" href="#starters">Starters</Nav.Link>
                        ...
                        <Nav.Link onClick={() => selectSubMenu('Extras')} className="menu-item" href="#extras">Extras</Nav.Link>
